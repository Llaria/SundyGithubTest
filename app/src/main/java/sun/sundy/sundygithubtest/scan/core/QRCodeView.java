...
public abstract class QRCodeView extends RelativeLayout implements Camera.PreviewCallback {
    ...
    public void onPreviewFrame(final byte[] data, final Camera camera) {
        if (SundyLogUtil.isDebug()) {
            SundyLogUtil.d("onPreviewFrame 时间间隔：" + (System.currentTimeMillis() - mLastPreviewFrameTime) + "ms");
        ...
        mProcessDataTask = new ProcessDataTask(camera, data, this, SundyLogUtil.isPortrait(getContext())).perform();
    }
...
//            SundyLogUtil.d("亮度：" + cameraLight);
    ...
    protected boolean transformToViewCoordinates(final PointF[] pointArr, final Rect scanBoxAreaRect, final boolean isNeedAutoZoom, final String result) {
        ...
        try {
            ...
            int statusBarHeight = SundyLogUtil.getStatusBarHeight(getContext());
